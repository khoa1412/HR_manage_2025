...
export default function OvertimeTab({ overtimeRequests, quickStats, onShowForm }) {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-medium text-gray-900">Quản lý tăng ca</h3>
        <button 
          onClick={onShowForm}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card p-6 text-center">
          ...
          <div className="text-sm text-gray-500">Tăng ca tháng này</div>
        </div>
        <div className="card p-6 text-center">
      ...
      <div className="card">
        <div className="px-6 py-4 border-b border-gray-200">
          <h4 className="text-lg font-medium text-gray-900">Lịch sử tăng ca</h4>
        </div>
